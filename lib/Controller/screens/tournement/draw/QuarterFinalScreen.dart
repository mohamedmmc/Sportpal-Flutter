...
class QuarterFinalScreen extends StatefulWidget {
  const QuarterFinalScreen({Key? key}) : super(key: key);

  @override
  _QuarterFinalScreenState createState() => _QuarterFinalScreenState();
}

class _QuarterFinalScreenState extends State<QuarterFinalScreen> {
  @override
